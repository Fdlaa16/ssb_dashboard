...
<head>
    <meta charset="UTF-8">
    <title>Aktivasi Berhasil - SSB PUTRA MUDA BALARAJA</title>
</head>
        ...
        ">
                    ...
                    <tr>
                        <td style="padding: 0 20px 20px 20px; color: #333;">
                            <h2 style="color: #6C63FF; text-align: center; margin: 0 0 20px 0;">Selamat! Aktivasi Anda
                                Berhasil</h2>

                            <p>Yth <strong>{{ $player->name }}</strong>,</p>

                            <p>Selamat! Anda sudah menjadi pemain aktif di SSB PUTRA MUDA BALARAJA. Kami sangat
